...
sgMail.setApiKey('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');
...
//   sendgridTransport({
//     auth: {
//       api_key: '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' //process.env.SENDGRID_KEY,
//     },
//   })
// );
  ...
  bcrypt
    ...
    .then((savedUser) => {
      ...
      return sgMail.send({
        ...
        from: 'rav.dan.rt20@rait.ac.in', // Change to your verified sender
        subject: 'Verify your Account on FoodHub',
        html: ` <p>Please verify your email by clicking on the link below - FoodHub</p><p>Click this <a href="http://localhost:3002/auth/verify/${token}">link</a> to verify your account.</p>`,
